...
const Playerss = () => {
  ...
  const [progressData, setProgressData] = useState(null); // Store user's progress
                    ...
                    {chapter.chapterContent.map((lecture, i) => (
                      <li className='flex items-start gap-2 py-1' key={i}>
                        <img
                          ...
                          src={progressData && progressData.lectureCompleted.includes(lecture.lectureId) ? assets.blue_tick_icon : assets.play_icon} // Adjust icon based on completion
                          alt='play-icon'
                        />
