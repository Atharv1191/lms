...
const SearchBar = ({data}) => {
  ...
  return (
        ...
        <form onSubmit={onSearchHandler} className='max-w-xl w-full md:h-14 h-12 flex items-center bg-white border border-gray-500/20 rounded'>
            ...
            <button type='submit'  className="bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 rounded text-white md:px-10 px-7 md:py-3 py-2 mx-1">Search</button>
        </form>
